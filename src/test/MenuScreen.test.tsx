...
describe('MenuScreen', () => {
  it('renders with 50% black transparency overlay', () => {
    ...
    // Check for Tailwind background class
    expect(menuScreen.className).toContain('bg-black/50')
  })
  ...
  it('displays FLAPPY BIRD title in 36px bold white with black outline', () => {
    ...
    expect(title.className).toContain('text-[36px]')
  ...
  it('displays instruction text below title', () => {
    ...
    expect(instruction.className).toContain('text-[18px]')
  })
  ...
  it('displays high score on menu screen', () => {
    ...
    expect(highScoreDisplay.className).toContain('text-[#ffd700]')
  })
